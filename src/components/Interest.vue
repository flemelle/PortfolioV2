    ...
    <section id="interests">
        <h2>Loisirs</h2>
            <InterestItem
                ...
                picture="https://resource.tiphereth.site/img/portfolio/bruce-lee-statue-sunset.jpg"
            />
            <InterestItem
                name="Escalade"
                ...
                picture="https://resource.tiphereth.site/img/portfolio/iStock_000052710440_Medium.jpg"
                :order = "false"
                />
            <InterestItem
                name="Musculation"
                ...
                picture="https://resource.tiphereth.site/img/portfolio/sven-mieke-jO6vBWX9h9Y-unsplash.jpg"
            />
            <InterestItem
                name="Cinéma"
                ...
                picture="https://resource.tiphereth.site/img/portfolio/12-hommes-en-colere-vote-secret-1.jpg"
                :order = "false"
                />
            <InterestItem
                name="Lecture"
                ...
                picture="https://resource.tiphereth.site/img/portfolio/1326129-3840x2160-desktop-4k-book-background-image.jpg"
            />
    </section>
</template>
<style scoped>
